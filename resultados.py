...
Testbench = {
    ...
    "tracking correlator": {
        "macc_v2": {
            "name": "Correlation",
            "samples": array([127, 255, 511, 1023, 2046, 4092, 8184, 16368, 10000000]),
        ...
        "mixcarr_v1": {
            "name": "Mix Carrier",
            "samples": array([127, 255, 511, 1023, 2046, 4092, 8184, 16368, 10000000]),
            "pl_time": array([1.207858, 1.208028, 1.208212, 1.208258, 1.208252, 1.208578, 1.211231, 1.327929, ]),
            "ps_time": array([0.552622, 0.552698, 0.552932, 0.553015, 0.552806, 0.553265, 0.555154, 0.577049, ])
        }
    }
}
