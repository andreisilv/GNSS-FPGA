...
################################################################
# This is a generated script based on design: tracking_v1
#
...
ist:hls:macc:3.0\
xilinx.com:hls:mixcarr:1.0\
xilinx.com:ip:processing_system7:5.5\
xilinx.com:hls:rescode:1.0\
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_A_Exponent_Width {59} \
   CONFIG.C_A_Fraction_Width {5} \
  ...
  # Create instance: macc_0, and set properties
  set macc_0 [ create_bd_cell -type ip -vlnv ist:hls:macc:3.0 macc_0 ]

  # Create instance: macc_1, and set properties
  set macc_1 [ create_bd_cell -type ip -vlnv ist:hls:macc:3.0 macc_1 ]

  # Create instance: mixcarr_1, and set properties
  set mixcarr_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mixcarr:1.0 mixcarr_1 ]
  ...
  # Create instance: rescode_1, and set properties
  set rescode_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:rescode:1.0 rescode_1 ]

  # Create instance: rst_ps7_0_100M, and set properties
  set rst_ps7_0_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_100M ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins mixcarr_1/strm_in]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins rescode_1/strm_in]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins macc_0/strm_in_A]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins macc_1/strm_in_A]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M00_AXIS [get_bd_intf_pins axis_broadcaster_1/M00_AXIS] [get_bd_intf_pins macc_0/strm_in_B]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M01_AXIS [get_bd_intf_pins axis_broadcaster_1/M01_AXIS] [get_bd_intf_pins macc_1/strm_in_B]
  ...
  connect_bd_intf_net -intf_net floating_point_1_M_AXIS_RESULT [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins floating_point_1/M_AXIS_RESULT]
  connect_bd_intf_net -intf_net macc_0_strm_out [get_bd_intf_pins floating_point_0/S_AXIS_A] [get_bd_intf_pins macc_0/strm_out]
  connect_bd_intf_net -intf_net macc_1_strm_out [get_bd_intf_pins floating_point_1/S_AXIS_A] [get_bd_intf_pins macc_1/strm_out]
  connect_bd_intf_net -intf_net mixcarr_1_strm_out [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins mixcarr_1/strm_out]
  ...
  connect_bd_intf_net -intf_net rescode_1_strm_out [get_bd_intf_pins axis_broadcaster_1/S_AXIS] [get_bd_intf_pins rescode_1/strm_out]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins floating_point_0/aclk] [get_bd_pins floating_point_1/aclk] [get_bd_pins macc_0/ap_clk] [get_bd_pins macc_1/ap_clk] [get_bd_pins mixcarr_1/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rescode_1/ap_clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins macc_0/ap_rst_n] [get_bd_pins macc_1/ap_rst_n] [get_bd_pins mixcarr_1/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rescode_1/ap_rst_n] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
